 ...
 * @author Usuario
 */
public class EnvioMensajes extends javax.swing.JFrame implements ExceptionListener {
     ...
     */
    public EnvioMensajes(String nombreEnvia) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        message = nombreEnvio + "\n"+ message;
        MessageSender sendMessages = new MessageSender();
        try {
